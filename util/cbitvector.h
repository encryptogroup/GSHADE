...
{
public:
	CBitVector(){ m_pBits =  NULL; m_nSize = 0; m_nKey = NULL;}
	CBitVector(int bits){ m_pBits =  NULL; m_nSize = 0; m_nKey = NULL; Create(bits);}
	CBitVector(int bits, BYTE* seed, int& cnt){ m_pBits =  NULL;
	m_nSize = 0; m_nKey = NULL; Create(bits, seed, cnt);}
